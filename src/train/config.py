...
EXP_HYPER_LIST = {'Data': {'dataset': None, 'data_aug': None, 'seq_filter_len': None,
                  ...
                  'Evaluation': {'split_type': None, 'split_mode': None, 'eval_mode': None, 'metric': None, 'k': None,
                                 'valid_metric': None, 'eval_batch': None, 'do_test_with_eval': None},
...
def get_default_config():
    ...
    parser.add_argument('--save', default='save', type=str, help='model saving dir')
    parser.add_argument('--model_saved', default=None, type=str, help='')
