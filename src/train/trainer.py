...
class Trainer:
    def __init__(self, config):
        ...
        self.do_test_with_eval = self.do_test and self.config.do_test_with_eval
    ...
    def training(self):
        ...
        for epoch in range(self.epoch_num):
            ...
            if self.do_test_with_eval:
                test_metric_res = self.test_model(self.data_dict['test'], load_best_model=False)
    ...
    def test_model(self, test_data_pair, model_name=None, load_best_model=True):
        if model_name is None:
            model_name = self.model_name
        SpecifiedDataSet = load_specified_dataset(model_name, self.config)
